...
from dashboard.routes import overview, jobs, logs, flags, events, audit, summary, previews
...
def create_app() -> FastAPI:
    ...
    for module in (overview, jobs, logs, flags, events, audit, summary, previews):
