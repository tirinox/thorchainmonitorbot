...
TWITTER_T_CO_LENGTH = 23
TWITTER_T_CO_EXAMPLE = 'https://t.co/1234567890'
...
def twitter_replace_url_example(text):
    # all links will be shortened using t.co
    return REGEX_URL.sub(TWITTER_T_CO_EXAMPLE, text)
