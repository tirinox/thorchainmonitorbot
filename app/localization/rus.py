...
class RussianLocalization(BaseLocalization):
    ...
    def text_node_op_welcome_text_part1(self):
        return bold('Добро пожаловать в Инстременты Операторов Нод.')
...
TEXT_NOP_ADD_INSTRUCTIONS = '🤓 Если вам уже известны адреса интересующих вас нод, ' \
    ...
    def text_nop_success_remove_banner(self, node_addresses):
        ...
        return f'😉 Успех! Вы убрали ноды из вашего списка слежения: {node_addresses_text} ({len(node_addresses)} всего).'
