...
class RussianLocalization(BaseLocalization):
    ...
    TEXT_NOP_SLASH_PERIOD = 'Отлично! Выберите период мониторинга.\n' \
                            'К примеру, если вы установите <i>10 минут</i> и порог <i>{pts} очков</i>, то ' \
                            'вы получите уведомление, если ваша нода наберет ' \
                            '<i>{pts} очков штрафа</i> за последние <i>10 минут</i>.'
