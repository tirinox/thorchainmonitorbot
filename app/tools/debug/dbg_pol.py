...
async def demo_pol_1(app: LpAppFramework):
    pol_fetcher = POLAndRunePoolFetcher(app.deps, reserve_address=get_reserve_address(app))
...
#                 return data
#
#     async def _find_stats_ago_random_hardcode(self, period_ago) -> Optional[AlertPOLState]:
#         pol_state = POLState(
#             usd_per_rune=1.5,
