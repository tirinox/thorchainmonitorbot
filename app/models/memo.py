...
class ActionType(Enum):
    ...
    GROUP_ALL = (ADD_LIQUIDITY, SWAP, WITHDRAW, DONATE, THORNAME, LOAN_OPEN, LOAN_CLOSE, BOND, UNBOND, LEAVE,
                 TRADE_ACC_DEPOSIT, TRADE_ACC_WITHDRAW, RUNEPOOL_ADD, RUNEPOOL_WITHDRAW, LIMIT_ORDER, REFUND,
                 OUTBOUND, RESERVE, NOOP)
    GROUP_MAIN = (ADD_LIQUIDITY, SWAP, WITHDRAW)
