from services.lib.explorers import get_explorer_url, NetworkIdents, Chains
from services.lib.texts import link_with_domain_text


def test_expl1():
    assert get_explorer_url(NetworkIdents.CHAOSNET_BEP2CHAIN, Chains.BNB,
    ...
    assert get_explorer_url(NetworkIdents.CHAOSNET_BEP2CHAIN, Chains.RUNE,
    ...
    assert get_explorer_url(NetworkIdents.TESTNET_MULTICHAIN, Chains.BNB,
