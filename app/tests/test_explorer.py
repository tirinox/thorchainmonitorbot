...
def test_expl1():
    assert get_explorer_url_to_address(NetworkIdents.CHAOSNET_BEP2CHAIN, Chains.BNB,
    ...
    assert get_explorer_url_to_address(NetworkIdents.CHAOSNET_BEP2CHAIN, Chains.THOR,
