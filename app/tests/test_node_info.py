...
def test_nonsense():
    ...
    c_non_1 = NodeSetChanges([], [], [], [], all_nodes)
    ...
    c_non_2 = NodeSetChanges([node_white], [], [], [], all_nodes + [node_white])
    ...
    c_non_4 = NodeSetChanges([], [node_good_standby], [], [], all_nodes)
    ...
    c_non_5 = NodeSetChanges([node_white], [], [node_good_active], [], all_nodes)
